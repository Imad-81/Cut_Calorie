      ...
      {items.map(({ href, label, icon: Icon }) => {
        ...
        return (
          <Link
            ...
            prefetch={true}
            className={cn(
              "flex min-h-11 min-w-11 flex-col items-center justify-center rounded-2xl px-3 py-2 text-[10px] font-semibold uppercase tracking-[0.22em] transition touch-manipulation",
